package lists.exercise10

import lists.exercise10.List.*

/**
 * Используйте новую функцию foldLeft, чтобы создать новые версии sum,
 * product и length, не страдающие проблемой переполнения стека.
 */
fun main() {
    println(sum(List(2, 22, 44)))
}
